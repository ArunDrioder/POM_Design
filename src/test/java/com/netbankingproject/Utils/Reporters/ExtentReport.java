package com.netbankingproject.Utils.Reporters;
...
public class ExtentReport extends TestListenerAdapter
{
    ...
    public static String reportPath = "C:\\Backup\\Selenium - Workspace\\POM_Design\\test-output\\"+"New Automation Report";
    ...
    public void onStart(ITestContext testContext)
    {
        ...
        new File(actualReportPath).renameTo(new File(
                "C:\\Backup\\Selenium - Workspace\\POM_Design\\test-output\\"+ "Automation_" + filePathdate + ".html"));
        ...
        extentReport.setSystemInfo("Net Banking", "Extent Report");
    ...
    public void onTestFailure(ITestResult tr)
    {
        ...
        String screenshotPath="C:\\Backup\\Selenium - Workspace\\POM_Design\\Screenshots"+tr.getName()+".png";
